...
- In subtle editorial mode, preserve the smallest set of marks that keeps the photograph source-readable while improving clarity and balance. Do not remove distinctive evidence just to make the result more abstract.
...
- Reject mark sets that read as a travel sticker, cute icon, generic logo, unrelated symbol system, or exact scene tracing. A quietly recognizable distilled scene structure is acceptable.
...
- Visual intention:
- Abstraction intensity: subtle-editorial / poetic-minimal / stronger-artistic
- Element:
- Why distinctive:
...
- One authored distortion or omission that clarifies the proposition:
...
- Literal nouns to translate into abstract roles:
...
LAYOUT BUDGET
- Reconstructed motif target width: 35–45% of lower-panel width
- Reconstructed motif maximum height: 32% of lower-panel height
- Target visual empty space: 65–75%
...
- Does it make the source structure cleaner and more memorable rather than merely summarize objects?
- Would removing one more recognizable object make the result feel disconnected from this exact photo? If yes, keep it.
- Does any literal noun in the prompt encourage a small object drawing? If yes, translate it into a formal role.
- Does the complete reconstructed motif stay within 35–45% of panel width and at most 32% of panel height?
